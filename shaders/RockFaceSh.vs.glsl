...
layout(location = 5) in vec4 _231;
layout(location = 6) in vec4 _249;
layout(location = 6) out vec4 _253;
...
void main()
{
    ...
    vec4 _230 = vec4(equal(ivec4(_231 * 256.0), ivec4(int(_97._m4))));
    _150.w = dot(_230, _249);
    _253 = vec4(mix((_150.xyz * 0.014999999664723873138427734375) + vec3(0.0350000001490116119384765625), _150.xyz, vec3(_97._m5)), 1.0 - _97._m5);
