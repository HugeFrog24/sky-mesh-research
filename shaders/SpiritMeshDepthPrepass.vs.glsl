...
layout(binding = 2, std140) uniform _47_49
{
    vec4 _m0;
    vec4 _m1;
    vec4 _m2;
...
layout(location = 1) in vec3 _42;
layout(location = 2) out vec3 _45;
...
void main()
{
    ...
    _30 = mat3(_14._m1[0].xyz, _14._m1[1].xyz, _14._m1[2].xyz) * _42;
    _45 = _49._m16 - _9;
    _57 = _59;
    _61 = _62;
    gl_Position = _49._m8 * vec4(_9, 1.0);
