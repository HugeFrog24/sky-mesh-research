...
layout(location = 5) in vec4 _213;
layout(location = 2) out vec4 _230;
layout(location = 6) in vec4 _235;
layout(location = 3) out vec4 _242;
layout(location = 7) in vec4 _283;
...
void main()
{
    ...
    vec4 _212 = vec4(equal(ivec4(_213 * 256.0), ivec4(int(_97._m3))));
    _230 = vec4(_97._m2, dot(_212, _235));
    _242 = vec4(mix((_230.xyz * 0.014999999664723873138427734375) + vec3(0.0350000001490116119384765625), _230.xyz, vec3(_97._m5)), 1.0 - _97._m5);
