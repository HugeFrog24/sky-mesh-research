...
layout(location = 2) out vec3 _60;
layout(location = 0) in vec3 _66;

void main()
{
    _9 = vec4(_15._m41 + _15._m45, _26.w);
    _37 = (_39 + _43._m1.xy) + (_43._m1.zw * _15._m20);
    _60 = (_43._m0 * vec4(_66, 1.0)).xyz;
    gl_Position = _15._m8 * vec4(_60, 1.0);
