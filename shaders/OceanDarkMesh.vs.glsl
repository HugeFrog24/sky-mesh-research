...
void main()
{
    ...
    float _165 = 1.0;
    vec2 _193 = (((((_37.xz + _64._m27.xz) * 77.0) * vec2(0.00048828125)) - floor((_64._m16.xz * 77.0) * vec2(0.00048828125))) * _165) + _42._m1.xz;
    _166 = vec4(_193.x, _193.y, _166.z, _166.w);
    vec2 _221 = (((((_37.xz + _64._m27.xz) * 296.0) * vec2(0.001953125)) - floor((_64._m16.xz * 296.0) * vec2(0.001953125))) * _165) + _42._m2.xz;
    _166 = vec4(_166.x, _166.y, _221.x, _221.y);
    vec2 _250 = (((((_37.xz + _64._m27.xz) * 104.0) * vec2(0.0009765625)) - floor((_64._m16.xz * 104.0) * vec2(0.0009765625))) * _165) + _42._m3.xz;
