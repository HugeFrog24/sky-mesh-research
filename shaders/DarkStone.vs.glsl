...
layout(location = 2) out vec3 _128;
layout(location = 6) out vec3 _142;
layout(location = 7) out vec3 _154;
layout(location = 3) out vec4 _160;
layout(location = 3) in vec4 _161;
layout(location = 4) out vec4 _163;
layout(location = 4) in vec4 _164;
layout(location = 5) out vec2 _167;
layout(location = 5) in vec4 _176;
layout(location = 6) in vec4 _178;
layout(location = 7) in vec4 _180;
layout(location = 8) out vec4 _182;
layout(location = 9) out vec4 _183;
layout(location = 10) out vec4 _184;
