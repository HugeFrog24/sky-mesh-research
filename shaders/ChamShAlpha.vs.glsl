...
layout(location = 10) out vec2 _174;
layout(location = 5) in vec4 _177;
layout(location = 6) in vec4 _179;
layout(location = 7) in vec4 _181;
layout(location = 2) out vec4 _183;
layout(location = 3) out vec4 _184;
layout(location = 4) out vec4 _185;
...
void main()
{
    ...
    _170 = _171;
    _174 = _171.zw;
    vec4 _186 = vec4(((_177.xyz * _177.xyz) / vec3(_177.w)) * mix(_31._m45, _31._m41, vec3(_179.x)), _179.w * exp2((255.0 * _179.z) - 128.0));
    vec4 _187 = vec4(_179.y * _179.y, 0.0, 0.0, 0.0);
    vec4 _188 = vec4((_181.xyz * 2.007874011993408203125) - vec3(1.007874011993408203125), _181.w);
    _183 = _186;
    _184 = _187;
    _185 = _188;
