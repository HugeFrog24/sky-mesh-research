...
layout(location = 10) out vec2 _117;
layout(location = 2) out vec4 _120;
layout(location = 3) out vec4 _156;
layout(location = 4) out vec4 _157;
...
void main()
{
    ...
    _113 = _114;
    _117 = _114.zw;
    vec3 _131 = mix(_36._m45, _36._m41, vec3(0.25)) * 0.100000001490116119384765625;
    _120 = vec4(_131.x, _131.y, _131.z, _120.w);
    _120.w = 1.0;
