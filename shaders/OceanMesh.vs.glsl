...
void main()
{
    ...
    float _90 = 25.0;
    float _91 = 10.0;
    float _289 = clamp((_89 * (1.0 / (_91 - _90))) - (_90 / (_91 - _90)), 0.0, 1.0);
    float _79 = _289;
    ...
    float _163 = 1.0;
    vec2 _191 = (((((_35.xz + _62._m27.xz) * 77.0) * vec2(0.00048828125)) - floor((_62._m16.xz * 77.0) * vec2(0.00048828125))) * _163) + _40._m1.xz;
    _164 = vec4(_191.x, _191.y, _164.z, _164.w);
    vec2 _219 = (((((_35.xz + _62._m27.xz) * 296.0) * vec2(0.001953125)) - floor((_62._m16.xz * 296.0) * vec2(0.001953125))) * _163) + _40._m2.xz;
    _164 = vec4(_164.x, _164.y, _219.x, _219.y);
    vec2 _248 = (((((_35.xz + _62._m27.xz) * 104.0) * vec2(0.0009765625)) - floor((_62._m16.xz * 104.0) * vec2(0.0009765625))) * _163) + _40._m3.xz;
